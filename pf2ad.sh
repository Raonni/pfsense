...
Search
Sign in or Sign up
 Watch 4  Star 3  Fork 6 pf2ad/pf2ad
 Code  Issues 0  Pull requests 0  Projects 0  Insights
Branch: 2.4.2-SAMBA4 Find file Copy pathpf2ad/pf2ad.sh
45e2eaf  20 days ago
 Luiz Gustavo update env to pfSense 2.4.2
1 contributor
RawBlameHistory     
Executable File  105 lines (85 sloc)  2.54 KB
#!/bin/sh
